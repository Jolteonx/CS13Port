...
/datum/subsystem/ticker/New()
	...
	login_music = pickweight(list('sound/ambience/title2.ogg' = 39, 'sound/ambience/title3r.ogg' = 20, 'sound/ambience/title1.ogg' = 39, 'sound/ambience/clown.ogg' = 2)) // choose title music!
